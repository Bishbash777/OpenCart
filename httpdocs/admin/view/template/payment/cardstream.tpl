			...
			<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
				<table class="form">
					<tr>
						...
						<td><select name="cardstream_module_type">
					...
					<tr>
						...
						<td><input type="text" name="cardstream_merchantid"
					...
					<tr>
						...
						<td><input type="text" name="cardstream_merchantsecret"
					...
					<tr>
						...
						<td><input type="text" name="cardstream_currencycode"
					...
					<tr>
						...
						<td><input type="text" name="cardstream_countrycode"
					...
					<tr>
						...
						<td><select name="cardstream_order_status_id">
					...
					<tr>
						...
						<td><select name="cardstream_geo_zone_id">
					...
					<tr>
						...
						<td><select name="cardstream_status">
					...
					<tr>
						...
						<td><input type="text" name="cardstream_sort_order"
								   value="<?php echo $cardstream_sort_order; ?>" size="1"/></td>
					</tr>
				</table>
			</form>
		</div>
