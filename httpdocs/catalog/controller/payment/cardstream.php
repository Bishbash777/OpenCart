	...
	class ControllerPaymentCardstream extends Controller {
		...
		protected function index() {
			...
			if ( file_exists( DIR_TEMPLATE . $this->config->get( 'config_template' ) .
							  '/template/payment/cardstream.tpl' )
			) {

				$this->template = $this->config->get( 'config_template' ) . '/template/payment/cardstream.tpl';

			} else {

				$this->template = 'default/template/payment/cardstream.tpl';
